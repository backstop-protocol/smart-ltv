import {
  ...
  import { ethers as ethers_v6 } from "ethers6"
  ...
  const parametersUrl =
    "https://raw.githubusercontent.com/backstop-protocol/smart-ltv/main/params/MultisigExecutorParameters.json";
...
export interface Parameter {
  ...
  Web3Function.onRun(async (context: Web3FunctionContext) => {
    ...
    const v6_provider = new ethers_v6.JsonRpcProvider('https://eth.llamarpc.com');
      ...
      if(pendingTxs.count > 0) {
        ...
        for(const pendingTx of pendingTxs.results) {
          ...
          if(pendingTx.confirmations.length >= pendingTx.confirmationsRequired ) {
            ...
            // const safeTx = await safeSdk.toSafeTransactionType(pendingTx);
